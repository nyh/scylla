...
# Test that when a table has a LSI, if the indexed attribute is missing, the
...
def test_lsi_missing_attribute(test_table_lsi_1):
    ...
    # Query, and a scan of the index won't find the second item.
    ...
    # an item will "never" appear in the index. We do this test last,
